...
namespace FlickrViewer
{
    public partial class FlickrViewerForm : Form
    {
        ...
        private async void searchButton_Click(object sender, EventArgs e)
        {
            ...
            var flickrURL = string.Format("https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key={0}&tags={1}&tag_mode=all&privacy_filter=1", KEY, inputTextBox.Text.Replace(" ", ","));
            ...
            try
            {
                ...
                XDocument xmlResponse = XDocument.Parse(await flickrTask);
